import { arrowUp, copyrightSign } from "../assets/icons";
...
const Footer = () => {
    ...
    <footer className="max-container">
        <a className="text-white float-right" href="#nav"><img src={arrowUp} alt="" width={32} height={32} className="text-white bg-slate-gray p-2"/></a>
